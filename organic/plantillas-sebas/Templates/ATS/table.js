...
(function () {
    var out = {};
    var html_jobs = document.querySelectorAll('table[id="searchresults"] > tbody > tr');
    var jobs = [];
    for (var elem of html_jobs) {
        ...
        job.location = elem.querySelector('span[class="jobLocation"]').textContent.trim();
...
(function () {
    ...
    for (const a of document.querySelectorAll('span[class="joblayouttoken-label"]')) {
    ...
    if (full_html) {
        ...
        job.html = removeTextAfter(job.html, /OM SYSTRA|Ansökan|To Apply|How to Apply/ig, true);
