...
(function() {
    ...
    if (typeof msg == "undefined") msg = console.log;
     ...
     var multilink = document.querySelectorAll('a[class="action-link ph-cc-d-p-a-0 au-target"]'); //selector de las categorias de los trabajos
  	var urls = []
...
(function() {
  ...
  var jobs = [];for(var x in html_jobs){
    ...
    if(job.location.includes("-")){
      ...
      job.location = job.location[0]+', '+job.location[2] 
    }
