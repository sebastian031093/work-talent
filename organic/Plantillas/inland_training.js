...
//-----------------------------------------------------------
 (function() {
	...
	if(document.querySelector('button.btn.btn-primary.btn-sm.toolbarButton'))
	{
	document.querySelector('button.btn.btn-primary.btn-sm.toolbarButton').click();
	out.wait = 4000;
	msg("\x1b[41mVOLVER"); // 1) Mensaje
	}
	else
	{
	msg("\x1b[41mNOOOOOO VOLVER"); // 1) Mensaje
	}
