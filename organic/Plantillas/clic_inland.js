...
(function() {
    var out = {};
    if(document.querySelector('body > app-footer > footer:nth-child(1) > div.footer-top > div > div:nth-child(3) > ul > li:nth-child(1) > a')){
      document.querySelector('body > app-footer > footer:nth-child(1) > div.footer-top > div > div:nth-child(3) > ul > li:nth-child(1) > a').click();
      out.wait = 4000;
...
//-----------------------------------------------------------
 (function() {
     ...
     /*DEFINIMOS LOS SELECTORES DEL JOBSITE*/
       var out = {}; 
       var selector_jobs = "#offre"; // 1) Selector de cada job.     
       var selector_titulo = "h3"; // 2) Selector titulo del job.
       var selector_location = "#offre-bottom > div:nth-child(1)"; // 3) Selector localizacion del job.
       var selector_desc = "#Description"; // 4) Selector de la descripcion de los jobs.
      ...
      /*VARIABLES LISTAS PARA PASAR AL EXTRACT*/
        if (infoTrabajo) {
             ...
             infoTrabajo.querySelector(' #offre-bottom > div:nth-child(3) > button').click();
